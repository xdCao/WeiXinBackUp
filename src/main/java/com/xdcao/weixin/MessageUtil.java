...
public class MessageUtil {
    ...
    public static final String CONTENT = "Content";  //文字消息内容
     ...
     */
    public static String imageMessageToXml(PicRespMessage imageMessage) {
     ...
     */
    public static String videoMessageToXml(VideoRespMessage videoMessage) {
